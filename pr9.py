...
fileName=os.path.join(dataorg,'blue_front_no_na.jpg')
print(fileName)
...
for angle in range(0,360,15):
    ...
    cv2.waitKey(50)
    output_folder = "C:/Users/SBA/opencvDojang/surplus_image"
    output_filename = f"rotated_{angle}_blue_front_no_na.jpg"  # 파일 이름 설정
    output_filename = os.path.join(output_folder, f"rotated_{angle}_blue_front_no_na.jpg")
